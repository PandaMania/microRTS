 ...
 * @author santi
 */
public class HEIRDownsamplingUCT extends AIWithComputationBudget implements InterruptibleAI {
    ...
    HEIRDownsamplingUCTNode tree = null;
    ...
    public HEIRDownsamplingUCT(UnitTypeTable utt) {
    ...
    public HEIRDownsamplingUCT(int available_time, int max_playouts, int lookahead, long maxactions, int max_depth, AI policy, EvaluationFunction a_ef) {
    ...
    public AI clone() {
        return new HEIRDownsamplingUCT(TIME_BUDGET, ITERATIONS_BUDGET, MAXSIMULATIONTIME, MAXACTIONS, MAX_TREE_DEPTH, randomAI, ef);
    }  
    ...
    public void startNewComputation(int a_player, GameState gs) throws Exception {
        ...
        tree = new HEIRDownsamplingUCTNode(playerForThisComputation, 1-playerForThisComputation, gs, null, MAXACTIONS, evaluation_bound);
        gs_to_start_from = gs;
    }    
    ...
    public void computeDuringOneGameFrame() throws Exception {
        ...
        while(true) {
            HEIRDownsamplingUCTNode leaf = tree.UCTSelectLeaf(playerForThisComputation, 1-playerForThisComputation, MAXACTIONS, cutOffTime, MAX_TREE_DEPTH);
    ...
    public PlayerAction getBestActionSoFar() {
        ...
        HEIRDownsamplingUCTNode mostVisited = null;
        for(int i = 0;i<tree.children.size();i++) {
            HEIRDownsamplingUCTNode child = tree.children.get(i);
        ...
        if (mostVisitedIdx == -1) {
            System.err.println("HEIRDownsamplingUCT.getBestActionSoFar: mostVisitedIdx == -1!!! tree.children.size() = " + tree.children.size());
