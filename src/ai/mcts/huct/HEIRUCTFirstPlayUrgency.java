 ...
 * @author santi
 */
public class HEIRUCTFirstPlayUrgency extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public HEIRUCTNodeFirstPlayUrgency tree = null;
    ...
    public HEIRUCTFirstPlayUrgency(UnitTypeTable utt) {
        this(100,-1,100,10,
             new RandomBiasedAI(),
    ...
    public HEIRUCTFirstPlayUrgency(int available_time, int max_playouts, int lookahead, int max_depth, AI policy, EvaluationFunction a_ef, double a_FPUvalue) {
    ...
    public AI clone() {
        return new HEIRUCTFirstPlayUrgency(TIME_BUDGET, ITERATIONS_BUDGET, MAXSIMULATIONTIME, MAX_TREE_DEPTH, randomAI, ef, FPUvalue);
    }  
    ...
    public void startNewComputation(int a_player, GameState gs) throws Exception {
        ...
        tree = new HEIRUCTNodeFirstPlayUrgency(playerForThisComputation, 1-playerForThisComputation, gs, null, evaluation_bound, FPUvalue);
        gs_to_start_from = gs;
        total_runs_this_move = 0;
...
//            System.out.println("playouts " + ITERATIONS_BUDGET + " - " + nPlayouts);
    ...
    public double monteCarloRun(int player, long cutOffTime) throws Exception {
        HEIRUCTNodeFirstPlayUrgency leaf = tree.UCTSelectLeaf(player, 1-player, cutOffTime, MAX_TREE_DEPTH);
...
//            System.err.println(this.getClass().getSimpleName() + ": claims there are no more leafs to explore...");
    ...
    public PlayerAction getBestActionSoFar() {
        ...
        for(int i = 0;i<tree.children.size();i++) {
            HEIRUCTNodeFirstPlayUrgency child = tree.children.get(i);
