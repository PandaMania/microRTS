...
public class UCT extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public UCT(UnitTypeTable utt, boolean PLAYOUT, MAST mast){
        this(100,-1,100,10,
                new RandomBiasedAI(),
                new SimpleSqrtEvaluationFunction3(),
                PLAYOUT,
    ...
    public UCT(int available_time, int max_playouts, int lookahead, int max_depth, AI policy, EvaluationFunction a_ef,boolean PLAYOUT,MAST mast) {
        super(available_time, max_playouts);
        MAXSIMULATIONTIME = lookahead;
        randomAI = policy;
        MAX_TREE_DEPTH = max_depth;
