...
public class MASTStrategyO2 extends MAST {
    ...
    public void simulate(GameState simulatedGs, int time){
        ...
        UnitTypeTable utt = simulatedGs.getUnitTypeTable();
        ...
        int numOfSimulations = (time - simulatedGs.getTime()) / TIME_PER_A_MATCH;
        int simulateTimePerMatch =(time - simulatedGs.getTime()) / NUMBER_OF_MATCHES;
